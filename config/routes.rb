RedmineApp::Application.routes.draw do
  ...
  match 'dependable_custom_fields/options', :to => 'context_menu_wizard#options', :via => :get, :format => 'json'
  match 'dependable_custom_fields/save', :to => 'context_menu_wizard#save', :via => :post, :format => 'json'
end
