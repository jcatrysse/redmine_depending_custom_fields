...
module RedmineDependingCustomFields
  class ExtendedUserFormat < Redmine::FieldFormat::UserFormat
    ...
    def possible_values_options(custom_field, object = nil)
      ...
      # Booleans may be stored as true/false or as '1'/'0' strings
      show_active = custom_field.show_active.to_s == '1' || custom_field.show_active == true
      show_registered = custom_field.show_registered.to_s == '1' || custom_field.show_registered == true
      show_locked = custom_field.show_locked.to_s == '1' || custom_field.show_locked == true
    ...
    def before_custom_field_save(custom_field)
      ...
      custom_field.exclude_admins = custom_field.exclude_admins.to_s == '1'
      custom_field.show_active = custom_field.show_active.to_s == '1'
      custom_field.show_registered = custom_field.show_registered.to_s == '1'
      custom_field.show_locked = custom_field.show_locked.to_s == '1'
    end
    ...
    def filtered_users(custom_field)
      ...
      users = users.where(admin: false) if custom_field.exclude_admins
      users
    end
